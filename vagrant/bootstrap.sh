...
RULES_FILE="https://raw.githubusercontent.com/NicolasBernaerts/ubuntu-scripts/master/android/51-android.rules"
...
#Build tools
echo y | $ANDROID_SDK_PATH/tools/android update sdk --all --filter android-23,build-tools-23.0.2,extra-google-m2repository,extra-android-m2repository --no-ui
